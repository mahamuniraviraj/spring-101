/*
 * 
 * File : DemoInitializingBeanDisposableBean.java
 * Version : 1.0
 * Date : 16 Dec, 2018
 ...
 */
// @Component
public class DemoInitializingBeanDisposableBean
        implements MyInterface, InitializingBean, DisposableBean {

    private static final Logger logger = LoggerFactory
            .getLogger(DemoInitializingBeanDisposableBean.class);
    ...
    public void destroy() throws Exception {
        logger.error(
                "DemoInitializingBeanDisposableBean::DisposableBean::destroy() method called");
    ...
    public void afterPropertiesSet() throws Exception {
        logger.error(
                "DemoInitializingBeanDisposableBean::InitializingBean::afterPropertiesSet() method called");

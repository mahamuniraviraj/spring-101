/*
 * 
 * File : DemoPostConstructPreDestroy.java
 * Version : 1.0
 * Date : 16 Dec, 2018
 ...
 */
// @Component
public class DemoPostConstructPreDestroy implements MyInterface {

    private static final Logger logger = LoggerFactory
            .getLogger(DemoPostConstructPreDestroy.class);
    ...
    public void myCustomInit() {
        logger.error(
                "DemoPostConstructPreDestroy::DisposableBean::init() method called");
    ...
    public void myCustomDestroy() {
        logger.error(
                "DemoPostConstructPreDestroy::InitializingBean::destroy() method called");
